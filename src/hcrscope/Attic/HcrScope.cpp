...
HcrScope::HcrScope(
    ...
    _statsUpdateInterval(5),
            _timeSeriesPlot(TRUE), _config("NCAR", "HcrScope"),
    ...
    std::string title = _config.getString("title", "HcrScope");
    title += " ";
...
//////////////////////////////////////////////////////////////////////
void HcrScope::initCombos(int channels, int tsLength, int gates) {
...
//////////////////////////////////////////////////////////////////////
void HcrScope::initGates(int gates) {
...
//////////////////////////////////////////////////////////////////////
void HcrScope::initChans(int channels) {
...
//////////////////////////////////////////////////////////////////////
void HcrScope::initFFT(int tsLength) {
...
//////////////////////////////////////////////////////////////////////
void HcrScope::saveImageSlot() {
    QString f = _config.getString("imageSaveDirectory", "c:/").c_str();

    QFileDialog d( this, tr("Save HcrScope Image"), f,
...
//////////////////////////////////////////////////////////////////////
void HcrScope::processTimeSeries(
...
//////////////////////////////////////////////////////////////////////
QButtonGroup* HcrScope::addTSTypeTab(
...
//////////////////////////////////////////////////////////////////////
void HcrScope::timerEvent(
        QTimerEvent*) {

}

//////////////////////////////////////////////////////////////////////
void HcrScope::gainChangeSlot(
        double gain) {
...
//////////////////////////////////////////////////////////////////////
void HcrScope::adjustGainOffset(
...
//////////////////////////////////////////////////////////////////////
void
HcrScope::newTSItemSlot(HcrDDS::TimeSeries* pItem) {
...
//////////////////////////////////////////////////////////////////////
void HcrScope::pauseSlot(
        bool p) {
    _paused = p;
}

//////////////////////////////////////////////////////////////////////
void HcrScope::channelSlot(
        int c) {
    _channel = c;
}

//////////////////////////////////////////////////////////////////////
void HcrScope::gateChoiceSlot(
        int index) {
    _gateChoice = index;
}

//////////////////////////////////////////////////////////////////////
void HcrScope::blockSizeSlot(
        int index) {
...
double HcrScope::zeroMomentFromTimeSeries(
