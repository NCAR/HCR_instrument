...
/**
 HcrScope provides a traditional real-time Ascope display of
 ...
 HcrScope is simply a data consumer; it does not know
 ...
 at a desired rate. HcrScope will attempt to render all data
 delivered.
 **/
class HcrScope : public QWidget, private Ui::HcrScope {
    Q_OBJECT
    ...
    protected:
        ...
        double zeroMomentFromTimeSeries(
                std::vector<double>& I,
                    std::vector<double>& Q);
        /// The configuration for HcrScope
        QtConfig _config;
