...
proc init_gui { IPINST } {
  ...
  ipgui::add_static_text $IPINST -name "txt1" -parent ${Page_0} -text {This Module is compatible with Ultrascale and Ultrascale+ PCIe Streaming IP cores in 256-bit Data, Address Aligned mode.}
