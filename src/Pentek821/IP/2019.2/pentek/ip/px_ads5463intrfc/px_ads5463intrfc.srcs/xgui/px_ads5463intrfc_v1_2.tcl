...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "iodelay_grp_ovr" -parent ${Page_0}
...
proc update_PARAM_VALUE.iodelay_grp_ovr { PARAM_VALUE.iodelay_grp_ovr } {
	# Procedure called to update iodelay_grp_ovr when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.iodelay_grp_ovr { PARAM_VALUE.iodelay_grp_ovr } {
	# Procedure called to validate iodelay_grp_ovr
	return true
}
...
proc update_MODELPARAM_VALUE.iodelay_grp_ovr { MODELPARAM_VALUE.iodelay_grp_ovr PARAM_VALUE.iodelay_grp_ovr } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.iodelay_grp_ovr}] ${MODELPARAM_VALUE.iodelay_grp_ovr}
}
