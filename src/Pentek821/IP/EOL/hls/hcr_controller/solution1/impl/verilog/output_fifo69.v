...
output   ap_idle;
output   ap_ready;
input  [840:0] pulse_queue_ch0_V_dout;
...
reg   [847:0] pulse_metadata_ch0_V_1_data_out;
...
reg   [847:0] pulse_metadata_ch0_V_1_payload_A;
reg   [847:0] pulse_metadata_ch0_V_1_payload_B;
...
assign pulse_terminate_fu_65_p3 = pulse_queue_ch0_V_dout[32'd840];

assign tmp_1_fu_77_p3 = {{1'd0}, {tmp_51_fu_73_p1}};

assign tmp_51_fu_73_p1 = pulse_queue_ch0_V_dout[839:0];

endmodule //output_fifo69
