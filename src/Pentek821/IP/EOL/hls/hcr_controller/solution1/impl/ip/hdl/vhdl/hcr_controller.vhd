...
port (
    ...
    pulse_metadata_ch1_V_TDATA : OUT STD_LOGIC_VECTOR (847 downto 0);
    pulse_metadata_ch2_V_TDATA : OUT STD_LOGIC_VECTOR (847 downto 0);
...
architecture behav of hcr_controller is 
    ...
    "hcr_controller,hls_ip_2017_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xcku060-ffva1517-2-e,HLS_INPUT_CLOCK=4.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=3.101667,HLS_SYN_LAT=-1,HLS_SYN_TPT=-1,HLS_SYN_MEM=56,HLS_SYN_DSP=0,HLS_SYN_FF=13070,HLS_SYN_LUT=5400}";
    ...
    constant ap_const_lv848_lc_2 : STD_LOGIC_VECTOR (847 downto 0) := "";
    ...
    signal scheduler_parser_U0_pulse_queue_0_V_din : STD_LOGIC_VECTOR (840 downto 0);
    signal scheduler_parser_U0_pulse_queue_0_V_write : STD_LOGIC;
    signal scheduler_parser_U0_pulse_queue_1_V_din : STD_LOGIC_VECTOR (840 downto 0);
    signal scheduler_parser_U0_pulse_queue_1_V_write : STD_LOGIC;
    signal scheduler_parser_U0_pulse_queue_2_V_din : STD_LOGIC_VECTOR (840 downto 0);
    signal scheduler_parser_U0_pulse_queue_2_V_write : STD_LOGIC;
    signal scheduler_parser_U0_pulse_queue_s_V_din : STD_LOGIC_VECTOR (840 downto 0);
    ...
    signal output_fifo69_U0_pulse_metadata_ch0_V_TDATA : STD_LOGIC_VECTOR (847 downto 0);
    ...
    signal output_fifo70_U0_pulse_metadata_ch0_V_TDATA : STD_LOGIC_VECTOR (847 downto 0);
    ...
    signal output_fifo_U0_out_V_TDATA : STD_LOGIC_VECTOR (847 downto 0);
    signal output_fifo_U0_out_V_TVALID : STD_LOGIC;
    signal pulse_queue_ch0_V_full_n : STD_LOGIC;
    signal pulse_queue_ch0_V_dout : STD_LOGIC_VECTOR (840 downto 0);
    signal pulse_queue_ch0_V_empty_n : STD_LOGIC;
    signal pulse_queue_ch1_V_full_n : STD_LOGIC;
    signal pulse_queue_ch1_V_dout : STD_LOGIC_VECTOR (840 downto 0);
    signal pulse_queue_ch1_V_empty_n : STD_LOGIC;
    signal pulse_queue_ch2_V_full_n : STD_LOGIC;
    signal pulse_queue_ch2_V_dout : STD_LOGIC_VECTOR (840 downto 0);
    signal pulse_queue_ch2_V_empty_n : STD_LOGIC;
    signal pulse_queue_schedule_full_n : STD_LOGIC;
    signal pulse_queue_schedule_dout : STD_LOGIC_VECTOR (840 downto 0);
    signal pulse_queue_schedule_empty_n : STD_LOGIC;
    ...
    component fifo_w841_d16_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
        if_write_ce : IN STD_LOGIC;
        if_din : IN STD_LOGIC_VECTOR (840 downto 0);
        if_full_n : OUT STD_LOGIC;
        if_write : IN STD_LOGIC;
        if_dout : OUT STD_LOGIC_VECTOR (840 downto 0);
        if_empty_n : OUT STD_LOGIC;
        if_read : IN STD_LOGIC );
    end component;


    component fifo_w841_d1_A IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
...
begin
    ...
    port map (
        ...
        pulse_queue_s_V_full_n => pulse_queue_schedule_full_n,
    ...
    port map (
        ...
        pps_q0 => pps_q0,
        pulse_queue_V_dout => pulse_queue_schedule_dout,
        pulse_queue_V_empty_n => pulse_queue_schedule_empty_n,
    ...
    pulse_queue_ch0_V_U : component fifo_w841_d16_S
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
    ...
    pulse_queue_ch1_V_U : component fifo_w841_d16_S
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    pulse_queue_ch2_V_U : component fifo_w841_d16_S
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    pulse_queue_schedule_U : component fifo_w841_d1_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
        ...
        if_full_n => pulse_queue_schedule_full_n,
        if_write => scheduler_parser_U0_pulse_queue_s_V_write,
        if_dout => pulse_queue_schedule_dout,
        if_empty_n => pulse_queue_schedule_empty_n,
    ...
    ap_reg_output_fifo_U0_ap_done_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst_n_inv = '1') then
                ap_reg_output_fifo_U0_ap_done <= ap_const_logic_0;
            else
                if ((ap_const_logic_1 = ap_sync_done)) then 
                    ap_reg_output_fifo_U0_ap_done <= ap_const_logic_0;
                else 
                    ap_reg_output_fifo_U0_ap_done <= (output_fifo_U0_ap_done or ap_reg_output_fifo_U0_ap_done);
                end if; 
            end if;
        end if;
    end process;
    ...
    ap_reg_scheduler_cycle_exac_U0_ap_done_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst_n_inv = '1') then
                ap_reg_scheduler_cycle_exac_U0_ap_done <= ap_const_logic_0;
            else
                if ((ap_const_logic_1 = ap_sync_done)) then 
                    ap_reg_scheduler_cycle_exac_U0_ap_done <= ap_const_logic_0;
                else 
                    ap_reg_scheduler_cycle_exac_U0_ap_done <= (scheduler_cycle_exac_U0_ap_done or ap_reg_scheduler_cycle_exac_U0_ap_done);
                end if; 
            end if;
        end if;
    end process;
    ...
    ap_reg_scheduler_parser_U0_ap_done_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst_n_inv = '1') then
                ap_reg_scheduler_parser_U0_ap_done <= ap_const_logic_0;
            else
                if ((ap_const_logic_1 = ap_sync_done)) then 
                    ap_reg_scheduler_parser_U0_ap_done <= ap_const_logic_0;
                else 
                    ap_reg_scheduler_parser_U0_ap_done <= (scheduler_parser_U0_ap_done or ap_reg_scheduler_parser_U0_ap_done);
                end if; 
            end if;
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_sync_ready) and (ap_const_logic_0 = scheduler_cycle_exac_U0_ap_ready))) then 
            ...
            elsif (((ap_const_logic_0 = ap_sync_ready) and (ap_const_logic_1 = scheduler_cycle_exac_U0_ap_ready))) then 
                scheduler_cycle_exac_U0_ap_ready_count <= std_logic_vector(unsigned(scheduler_cycle_exac_U0_ap_ready_count) + unsigned(ap_const_lv2_1));
            end if; 
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_0 = scheduler_parser_U0_ap_ready) and (ap_const_logic_1 = ap_sync_ready))) then 
                scheduler_parser_U0_ap_ready_count <= std_logic_vector(unsigned(scheduler_parser_U0_ap_ready_count) - unsigned(ap_const_lv2_1));
            elsif (((ap_const_logic_1 = scheduler_parser_U0_ap_ready) and (ap_const_logic_0 = ap_sync_ready))) then 
                scheduler_parser_U0_ap_ready_count <= std_logic_vector(unsigned(scheduler_parser_U0_ap_ready_count) + unsigned(ap_const_lv2_1));
            end if; 
        end if;
    end process;
    ...
    scheduler_cycle_exac_U0_ap_start <= (ap_start and (ap_sync_reg_scheduler_cycle_exac_U0_ap_ready xor ap_const_logic_1));
    scheduler_cycle_exac_U0_start_full_n <= ap_const_logic_0;
