...
output   ap_idle;
output   ap_ready;
input  [840:0] in_V_dout;
input   in_V_empty_n;
output   in_V_read;
output  [847:0] out_V_TDATA;
output   out_V_TVALID;
input   out_V_TREADY;
...
reg   [847:0] out_V_1_data_out;
reg    out_V_1_vld_in;
wire    out_V_1_vld_out;
wire    out_V_1_ack_in;
wire    out_V_1_ack_out;
reg   [847:0] out_V_1_payload_A;
reg   [847:0] out_V_1_payload_B;
reg    out_V_1_sel_rd;
reg    out_V_1_sel_wr;
wire    out_V_1_sel;
wire    out_V_1_load_A;
...
wire  signed [847:0] cast_fu_85_p1;
reg    ap_block_state2;
reg    ap_block_state2_io;
wire   [839:0] tmp_53_fu_73_p1;
wire   [840:0] tmp_1_fu_77_p3;
reg   [2:0] ap_NS_fsm;
reg    ap_block_state1;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((1'b1 == ap_continue)) begin
            ap_done_reg <= 1'b0;
        end else if (((1'b1 == ap_CS_fsm_state2) & ~((1'b0 == in_V_empty_n) | (1'b0 == out_V_1_ack_in) | (1'b1 == ap_block_state2_io)) & (1'd1 == pulse_terminate_fu_65_p3))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state2) & ~((1'b0 == in_V_empty_n) | (1'b0 == out_V_1_ack_in) | (1'b1 == ap_block_state2_io)) & (1'd1 == pulse_terminate_fu_65_p3))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state2) & ~((1'b0 == in_V_empty_n) | (1'b0 == out_V_1_ack_in) | (1'b1 == ap_block_state2_io)))) begin
        in_V_read = 1'b1;
    end else begin
        in_V_read = 1'b0;
    end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state2) & (1'd0 == pulse_terminate_fu_65_p3) & ~((1'b0 == in_V_empty_n) | (1'b0 == out_V_1_ack_in) | (1'b1 == ap_block_state2_io)))) begin
        out_V_1_vld_in = 1'b1;
    end else begin
        out_V_1_vld_in = 1'b0;
    end
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state2 : begin
            if (((1'b1 == ap_CS_fsm_state2) & ~((1'b0 == in_V_empty_n) | (1'b0 == out_V_1_ack_in) | (1'b1 == ap_block_state2_io)) & (1'd1 == pulse_terminate_fu_65_p3))) begin
                ap_NS_fsm = ap_ST_fsm_state1;
            end else if (((1'b1 == ap_CS_fsm_state2) & (1'd0 == pulse_terminate_fu_65_p3) & ~((1'b0 == in_V_empty_n) | (1'b0 == out_V_1_ack_in) | (1'b1 == ap_block_state2_io)))) begin
        ...
        ap_ST_fsm_state3 : begin
            if (((1'b1 == ap_CS_fsm_state3) & (out_V_1_ack_in == 1'b1))) begin
                ap_NS_fsm = ap_ST_fsm_state2;
            end else begin
                ap_NS_fsm = ap_ST_fsm_state3;
            end
...
always @ (*) begin
    ap_block_state2 = ((1'b0 == in_V_empty_n) | (1'b0 == out_V_1_ack_in));
end

always @ (*) begin
    ap_block_state2_io = ((1'd0 == pulse_terminate_fu_65_p3) & (1'b0 == out_V_1_ack_in));
end
...
assign pulse_terminate_fu_65_p3 = in_V_dout[32'd840];

assign tmp_1_fu_77_p3 = {{1'd0}, {tmp_53_fu_73_p1}};

assign tmp_53_fu_73_p1 = in_V_dout[839:0];
