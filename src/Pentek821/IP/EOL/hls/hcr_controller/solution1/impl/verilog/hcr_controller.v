...
(* CORE_GENERATION_INFO="hcr_controller,hls_ip_2017_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xcku060-ffva1517-2-e,HLS_INPUT_CLOCK=4.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=3.101667,HLS_SYN_LAT=-1,HLS_SYN_TPT=-1,HLS_SYN_MEM=56,HLS_SYN_DSP=0,HLS_SYN_FF=13070,HLS_SYN_LUT=5400}" *)
...
parameter    C_S_AXI_CFG_BUS_ADDR_WIDTH = 13;
...
output  [847:0] pulse_metadata_ch0_V_TDATA;
output  [847:0] pulse_metadata_ch1_V_TDATA;
output  [847:0] pulse_metadata_ch2_V_TDATA;
...
wire    ap_done;
wire    ap_idle;
wire   [7:0] cfg_pulse_sequence_start_index;
wire   [7:0] cfg_pulse_sequence_length;
...
wire   [4:0] scheduler_parser_U0_cfg_pulse_sequence_p_2_address0;
wire    scheduler_parser_U0_cfg_pulse_sequence_p_2_ce0;
...
wire   [7:0] scheduler_parser_U0_cfg_filter_coefs_ch0_address0;
wire    scheduler_parser_U0_cfg_filter_coefs_ch0_ce0;
wire   [7:0] scheduler_parser_U0_cfg_filter_coefs_ch1_address0;
wire    scheduler_parser_U0_cfg_filter_coefs_ch1_ce0;
wire   [7:0] scheduler_parser_U0_cfg_filter_coefs_ch2_address0;
...
wire   [840:0] scheduler_parser_U0_pulse_queue_0_V_din;
wire    scheduler_parser_U0_pulse_queue_0_V_write;
wire   [840:0] scheduler_parser_U0_pulse_queue_1_V_din;
wire    scheduler_parser_U0_pulse_queue_1_V_write;
wire   [840:0] scheduler_parser_U0_pulse_queue_2_V_din;
wire    scheduler_parser_U0_pulse_queue_2_V_write;
wire   [840:0] scheduler_parser_U0_pulse_queue_s_V_din;
...
wire   [1:0] scheduler_cycle_exac_U0_filter_select_ch0_V;
wire    scheduler_cycle_exac_U0_filter_select_ch0_V_ap_vld;
wire   [1:0] scheduler_cycle_exac_U0_filter_select_ch1_V;
...
wire   [847:0] output_fifo69_U0_pulse_metadata_ch0_V_TDATA;
...
wire   [847:0] output_fifo70_U0_pulse_metadata_ch0_V_TDATA;
...
wire   [847:0] output_fifo_U0_out_V_TDATA;
wire    output_fifo_U0_out_V_TVALID;
wire    pulse_queue_ch0_V_full_n;
wire   [840:0] pulse_queue_ch0_V_dout;
wire    pulse_queue_ch0_V_empty_n;
wire    pulse_queue_ch1_V_full_n;
wire   [840:0] pulse_queue_ch1_V_dout;
wire    pulse_queue_ch1_V_empty_n;
wire    pulse_queue_ch2_V_full_n;
wire   [840:0] pulse_queue_ch2_V_dout;
wire    pulse_queue_ch2_V_empty_n;
wire    pulse_queue_schedule_full_n;
wire   [840:0] pulse_queue_schedule_dout;
wire    pulse_queue_schedule_empty_n;
wire    ap_sync_done;
...
fifo_w841_d16_S pulse_queue_ch0_V_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
fifo_w841_d16_S pulse_queue_ch1_V_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
fifo_w841_d16_S pulse_queue_ch2_V_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
fifo_w841_d1_A pulse_queue_schedule_U(
    .clk(ap_clk),
    .reset(ap_rst_n_inv),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        ap_reg_output_fifo_U0_ap_done <= 1'b0;
    end else begin
        if ((1'b1 == ap_sync_done)) begin
            ap_reg_output_fifo_U0_ap_done <= 1'b0;
        end else begin
            ap_reg_output_fifo_U0_ap_done <= (output_fifo_U0_ap_done | ap_reg_output_fifo_U0_ap_done);
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        ap_reg_scheduler_cycle_exac_U0_ap_done <= 1'b0;
    end else begin
        if ((1'b1 == ap_sync_done)) begin
            ap_reg_scheduler_cycle_exac_U0_ap_done <= 1'b0;
        end else begin
            ap_reg_scheduler_cycle_exac_U0_ap_done <= (scheduler_cycle_exac_U0_ap_done | ap_reg_scheduler_cycle_exac_U0_ap_done);
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        ap_reg_scheduler_parser_U0_ap_done <= 1'b0;
    end else begin
        if ((1'b1 == ap_sync_done)) begin
            ap_reg_scheduler_parser_U0_ap_done <= 1'b0;
        end else begin
            ap_reg_scheduler_parser_U0_ap_done <= (scheduler_parser_U0_ap_done | ap_reg_scheduler_parser_U0_ap_done);
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_sync_ready) & (1'b0 == scheduler_cycle_exac_U0_ap_ready))) begin
        scheduler_cycle_exac_U0_ap_ready_count <= (scheduler_cycle_exac_U0_ap_ready_count - 2'd1);
    end else if (((1'b0 == ap_sync_ready) & (1'b1 == scheduler_cycle_exac_U0_ap_ready))) begin
        scheduler_cycle_exac_U0_ap_ready_count <= (scheduler_cycle_exac_U0_ap_ready_count + 2'd1);
    end
end

always @ (posedge ap_clk) begin
    if (((1'b0 == scheduler_parser_U0_ap_ready) & (1'b1 == ap_sync_ready))) begin
        scheduler_parser_U0_ap_ready_count <= (scheduler_parser_U0_ap_ready_count - 2'd1);
    end else if (((1'b1 == scheduler_parser_U0_ap_ready) & (1'b0 == ap_sync_ready))) begin
        scheduler_parser_U0_ap_ready_count <= (scheduler_parser_U0_ap_ready_count + 2'd1);
    end
end
...
assign output_fifo_U0_start_full_n = 1'b0;
...
assign scheduler_cycle_exac_U0_ap_start = (ap_start & (ap_sync_reg_scheduler_cycle_exac_U0_ap_ready ^ 1'b1));

assign scheduler_cycle_exac_U0_start_full_n = 1'b0;
