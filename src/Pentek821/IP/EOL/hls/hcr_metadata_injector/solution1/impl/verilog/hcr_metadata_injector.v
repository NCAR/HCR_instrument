...
reg   [823:0] pulse_metadata_V_0_data_out;
...
reg   [823:0] pulse_metadata_V_0_payload_A;
reg   [823:0] pulse_metadata_V_0_payload_B;
...
wire   [0:0] brmerge_fu_387_p2;
wire    ap_CS_fsm_state4;
reg   [0:0] tmp_2_reg_618;
reg   [0:0] brmerge_reg_672;
...
reg   [0:0] in_a_pulse_load_reg_622;
reg   [0:0] in_a_xfer_bundle_loa_reg_627;
reg   [31:0] sample_counter_load_1_reg_632;
reg   [7:0] decimation_counter_l_reg_637;
reg   [7:0] decimation_value_loa_reg_642;
reg   [0:0] break_after_pulse_lo_reg_647;
reg   [31:0] num_samples_load_reg_652;
wire   [0:0] in_a_xfer_bundle_3_fu_345_p2;
reg   [0:0] in_a_xfer_bundle_3_reg_657;
wire   [0:0] in_a_pulse_2_fu_357_p2;
reg   [0:0] in_a_pulse_2_reg_662;
...
wire    grp_handle_header_fu_175_pulse_metadata_V_TVALID;
...
reg    ap_reg_grp_handle_header_fu_175_ap_start;
reg   [0:0] in_a_pulse_fu_86;
reg    ap_predicate_op88_write_state4;
reg    ap_block_state4_io;
reg    ap_block_state4_on_subcall_done;
wire   [0:0] terminate_fu_476_p1;
reg   [0:0] in_a_xfer_bundle_fu_90;
reg   [31:0] sample_counter_fu_94;
wire   [31:0] sample_counter_1_sam_fu_436_p3;
reg   [7:0] decimation_counter_fu_98;
wire   [7:0] decimation_counter_1_fu_393_p2;
reg   [7:0] decimation_value_fu_102;
reg   [0:0] break_after_pulse_fu_106;
reg   [31:0] num_samples_fu_110;
wire   [0:0] tmp_1_fu_327_p2;
wire   [0:0] p_in_a_xfer_bundle_de_fu_333_p2;
wire   [0:0] p_in_a_xfer_bundle_fu_339_p2;
wire   [0:0] not_tmp_1_fu_351_p2;
wire   [0:0] brmerge_demorgan_fu_369_p2;
wire   [0:0] in_a_xfer_bundle_not_fu_375_p2;
wire   [0:0] tmp_fu_381_p2;
reg   [127:0] p_Result_s_fu_404_p4;
wire   [31:0] sample_counter_1_fu_430_p2;
...
#0 ap_reg_grp_handle_header_fu_175_ap_start = 1'b0;
end
...
always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        ap_reg_grp_handle_header_fu_175_ap_start <= 1'b0;
    end else begin
        if (((1'b1 == ap_CS_fsm_state3) & ~((1'b0 == i_data_V_data_V_0_vld_out) | (1'b1 == ap_block_state3_io)) & (1'd1 == tmp_2_fu_295_p3))) begin
            ap_reg_grp_handle_header_fu_175_ap_start <= 1'b1;
        end else if ((1'b1 == grp_handle_header_fu_175_ap_ready)) begin
            ap_reg_grp_handle_header_fu_175_ap_start <= 1'b0;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state4) & (1'd1 == tmp_2_reg_618) & ~((1'b1 == ap_block_state4_io) | (1'b1 == ap_block_state4_on_subcall_done)) & (1'd0 == terminate_fu_476_p1))) begin
        break_after_pulse_fu_106 <= grp_handle_header_fu_175_ap_return_3;
    end else if (((1'b1 == ap_CS_fsm_state1) & (ap_start == 1'b1))) begin
        break_after_pulse_fu_106 <= 1'd0;
    end
end
...
always @ (posedge ap_clk) begin
    ...
    end else if (((1'b1 == ap_CS_fsm_state3) & (1'b1 == ap_predicate_op82_write_state3) & ~((1'b0 == i_data_V_data_V_0_vld_out) | (1'b1 == ap_block_state3_io)))) begin
        decimation_counter_fu_98 <= 8'd1;
    end else if (((1'b1 == ap_CS_fsm_state3) & (1'd0 == tmp_2_fu_295_p3) & ~((1'b0 == i_data_V_data_V_0_vld_out) | (1'b1 == ap_block_state3_io)) & (1'd0 == brmerge_fu_387_p2))) begin
        decimation_counter_fu_98 <= decimation_counter_1_fu_393_p2;
    end else if (((1'b1 == ap_CS_fsm_state1) & (ap_start == 1'b1))) begin
        decimation_counter_fu_98 <= 8'd0;
    end
end
...
always @ (posedge ap_clk) begin
    ...
    end else if (((1'b1 == ap_CS_fsm_state4) & (1'd0 == tmp_2_reg_618) & ~((1'b1 == ap_block_state4_io) | (1'b1 == ap_block_state4_on_subcall_done)))) begin
        in_a_pulse_fu_86 <= in_a_pulse_2_reg_662;
    end else if (((1'b1 == ap_CS_fsm_state1) & (ap_start == 1'b1))) begin
        in_a_pulse_fu_86 <= 1'd0;
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state3) & ~((1'b0 == i_data_V_data_V_0_vld_out) | (1'b1 == ap_block_state3_io)))) begin
        ...
        tmp_2_reg_618 <= i_data_V_user_V_0_data_out[32'd72];
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state3) & (1'd0 == tmp_2_fu_295_p3) & ~((1'b0 == i_data_V_data_V_0_vld_out) | (1'b1 == ap_block_state3_io)))) begin
...
always @ (*) begin
    if ((((1'b1 == ap_CS_fsm_state3) & (1'd0 == tmp_2_fu_295_p3) & (1'd1 == brmerge_fu_387_p2)) | ((1'b1 == ap_CS_fsm_state4) & (1'd0 == tmp_2_reg_618) & (1'd1 == brmerge_reg_672)))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state3) & (1'b1 == ap_predicate_op82_write_state3) & (i_data_V_data_V_0_vld_out == 1'b1))) begin
        o_data_V_data_V_1_data_in = i_data_V_data_V_0_data_out;
    end else if (((1'b1 == ap_CS_fsm_state4) & (1'd1 == tmp_2_reg_618) & (1'b1 == grp_handle_header_fu_175_o_data_TVALID))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state3) & (1'b1 == ap_predicate_op82_write_state3) & ~((1'b0 == i_data_V_data_V_0_vld_out) | (1'b1 == ap_block_state3_io)))) begin
        o_data_V_data_V_1_vld_in = 1'b1;
    end else if (((1'b1 == ap_CS_fsm_state4) & (1'd1 == tmp_2_reg_618))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state4 : begin
            if (((1'b1 == ap_CS_fsm_state4) & ~((1'b1 == ap_block_state4_io) | (1'b1 == ap_block_state4_on_subcall_done)) & ((1'd0 == tmp_2_reg_618) | (1'd0 == terminate_fu_476_p1)))) begin
                ap_NS_fsm = ap_ST_fsm_state2;
            end else if (((1'b1 == ap_CS_fsm_state4) & (1'd1 == tmp_2_reg_618) & ~((1'b1 == ap_block_state4_io) | (1'b1 == ap_block_state4_on_subcall_done)) & (1'd1 == terminate_fu_476_p1))) begin
...
always @ (*) begin
    ap_block_state3_io = ((1'b0 == o_data_V_data_V_1_ack_in) & (1'b1 == ap_predicate_op82_write_state3));
end

always @ (*) begin
    ap_block_state4_io = ((1'b0 == o_data_V_data_V_1_ack_in) & (1'b1 == ap_predicate_op88_write_state4));
end

always @ (*) begin
    ap_block_state4_on_subcall_done = ((1'd1 == tmp_2_reg_618) & (1'b0 == grp_handle_header_fu_175_ap_done));
end
...
always @ (*) begin
    ap_predicate_op82_write_state3 = ((1'd0 == tmp_2_fu_295_p3) & (1'd1 == brmerge_fu_387_p2));
end

always @ (*) begin
    ap_predicate_op88_write_state4 = ((1'd0 == tmp_2_reg_618) & (1'd1 == brmerge_reg_672));
end
...
assign brmerge_demorgan_fu_369_p2 = (in_a_pulse_2_fu_357_p2 & dec_keep_fu_363_p2);

assign brmerge_fu_387_p2 = (tmp_fu_381_p2 | p_in_a_xfer_bundle_de_fu_333_p2);

assign dec_keep_fu_363_p2 = ((decimation_counter_fu_98 == decimation_value_fu_102) ? 1'b1 : 1'b0);

assign decimation_counter_1_fu_393_p2 = (decimation_counter_fu_98 + 8'd1);

assign grp_handle_header_fu_175_ap_start = ap_reg_grp_handle_header_fu_175_ap_start;

assign grp_handle_header_fu_175_break_after_pulse_re = break_after_pulse_lo_reg_647;

assign grp_handle_header_fu_175_in_a_pulse_read = in_a_pulse_load_reg_622;

assign grp_handle_header_fu_175_in_a_xfer_bundle_rea = in_a_xfer_bundle_loa_reg_627;

assign grp_handle_header_fu_175_o_data_TREADY = o_data_V_dest_V_1_state[1'd1];

assign grp_handle_header_fu_175_pulse_metadata_V_TVALID = pulse_metadata_V_0_state[1'd0];
...
assign in_a_pulse_2_fu_357_p2 = (in_a_pulse_fu_86 & not_tmp_1_fu_351_p2);

assign in_a_xfer_bundle_3_fu_345_p2 = (in_a_xfer_bundle_fu_90 & p_in_a_xfer_bundle_fu_339_p2);

assign in_a_xfer_bundle_not_fu_375_p2 = (in_a_xfer_bundle_fu_90 ^ 1'd1);

assign not_tmp_1_fu_351_p2 = (tmp_1_fu_327_p2 ^ 1'd1);
...
always @ (*) begin
    ...
    p_Result_s_fu_404_p4[32'd64] = |(in_a_pulse_2_fu_357_p2);
end

assign p_in_a_xfer_bundle_de_fu_333_p2 = (tmp_1_fu_327_p2 & break_after_pulse_fu_106);

assign p_in_a_xfer_bundle_fu_339_p2 = (p_in_a_xfer_bundle_de_fu_333_p2 ^ 1'd1);

assign pulse_metadata_V_0_ack_in = pulse_metadata_V_0_state[1'd1];

assign pulse_metadata_V_0_ack_out = grp_handle_header_fu_175_pulse_metadata_V_TREADY;
...
assign sample_counter_1_fu_430_p2 = (sample_counter_fu_94 + 32'd1);

assign sample_counter_1_sam_fu_436_p3 = ((dec_keep_reg_667[0:0] === 1'b1) ? sample_counter_1_fu_430_p2 : sample_counter_fu_94);

assign terminate_fu_476_p1 = grp_handle_header_fu_175_ap_return_0;

assign tmp_1_fu_327_p2 = ((sample_counter_fu_94 == num_samples_fu_110) ? 1'b1 : 1'b0);

assign tmp_2_fu_295_p3 = i_data_V_user_V_0_data_out[32'd72];

assign tmp_fu_381_p2 = (brmerge_demorgan_fu_369_p2 | in_a_xfer_bundle_not_fu_375_p2);
