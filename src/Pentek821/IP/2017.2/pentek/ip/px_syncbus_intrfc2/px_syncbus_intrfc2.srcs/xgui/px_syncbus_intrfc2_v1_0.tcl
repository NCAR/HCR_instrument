...
proc init_gui { IPINST } {
  ...
  ipgui::add_static_text $IPINST -name "sein_txt" -parent ${Additional_Input_Logic} -text {These Inputs are only available when TTL Input Signal Master id false (Slave)}
  ipgui::add_param $IPINST -name "has_gate_trig_se_in" -parent ${Additional_Input_Logic}
  ipgui::add_param $IPINST -name "has_sync_pps_se_in" -parent ${Additional_Input_Logic}
  ipgui::add_param $IPINST -name "has_ssmc_gate_se_in" -parent ${Additional_Input_Logic}
...
proc update_PARAM_VALUE.has_gate_trig_se_in { PARAM_VALUE.has_gate_trig_se_in } {
	# Procedure called to update has_gate_trig_se_in when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.has_gate_trig_se_in { PARAM_VALUE.has_gate_trig_se_in } {
	# Procedure called to validate has_gate_trig_se_in
	return true
}

proc update_PARAM_VALUE.has_gate_trig_se_out { PARAM_VALUE.has_gate_trig_se_out } {
...
proc update_PARAM_VALUE.has_ssmc_gate_se_in { PARAM_VALUE.has_ssmc_gate_se_in } {
	# Procedure called to update has_ssmc_gate_se_in when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.has_ssmc_gate_se_in { PARAM_VALUE.has_ssmc_gate_se_in } {
	# Procedure called to validate has_ssmc_gate_se_in
	return true
}

proc update_PARAM_VALUE.has_ssmc_gate_se_out { PARAM_VALUE.has_ssmc_gate_se_out } {
...
proc update_PARAM_VALUE.has_sync_pps_se_in { PARAM_VALUE.has_sync_pps_se_in } {
	# Procedure called to update has_sync_pps_se_in when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.has_sync_pps_se_in { PARAM_VALUE.has_sync_pps_se_in } {
	# Procedure called to validate has_sync_pps_se_in
	return true
}

proc update_PARAM_VALUE.has_sync_pps_se_out { PARAM_VALUE.has_sync_pps_se_out } {
...
proc update_MODELPARAM_VALUE.has_gate_trig_se_in { MODELPARAM_VALUE.has_gate_trig_se_in PARAM_VALUE.has_gate_trig_se_in } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.has_gate_trig_se_in}] ${MODELPARAM_VALUE.has_gate_trig_se_in}
}

proc update_MODELPARAM_VALUE.has_sync_pps_se_in { MODELPARAM_VALUE.has_sync_pps_se_in PARAM_VALUE.has_sync_pps_se_in } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.has_sync_pps_se_in}] ${MODELPARAM_VALUE.has_sync_pps_se_in}
}

proc update_MODELPARAM_VALUE.has_ssmc_gate_se_in { MODELPARAM_VALUE.has_ssmc_gate_se_in PARAM_VALUE.has_ssmc_gate_se_in } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.has_ssmc_gate_se_in}] ${MODELPARAM_VALUE.has_ssmc_gate_se_in}
}
