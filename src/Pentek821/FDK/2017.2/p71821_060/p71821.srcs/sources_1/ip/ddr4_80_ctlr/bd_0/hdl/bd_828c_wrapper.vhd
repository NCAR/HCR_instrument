...
--Date        : Fri Jan 22 18:25:27 2021
--Host        : apararchiver running 64-bit CentOS Linux release 8.0.1905 (Core)
--Command     : generate_target bd_828c_wrapper.bd
--Design      : bd_828c_wrapper
...
architecture STRUCTURE of bd_828c_wrapper is
  component bd_828c is
  port (
    IO_addr_strobe : out STD_LOGIC;
    IO_address : out STD_LOGIC_VECTOR ( 31 downto 0 );
    IO_byte_enable : out STD_LOGIC_VECTOR ( 3 downto 0 );
  ...
  end component bd_828c;
begin
bd_828c_i: component bd_828c
     port map (
      Clk => Clk,
