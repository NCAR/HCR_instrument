...
entity dataio_intrfc_wrapper is
  port (
    ...
    m_axis_adc_pctl_tvalid : out STD_LOGIC_VECTOR ( 0 to 0 );
...
dataio_intrfc_i: component dataio_intrfc
     port map (
      ...
      m_axis_adc_pctl_tdata(7 downto 0) => m_axis_adc_pctl_tdata(7 downto 0),
      m_axis_adc_pctl_tvalid(0) => m_axis_adc_pctl_tvalid(0),
