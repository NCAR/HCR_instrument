        ...
        configVarsDesc_("Direct configuration variable setters")
{
    ...
    configVarsDesc_.add_options()
        ...
        MEMBER_PROGOPT( pulse_filter_file_ch_0,            "description",                                  "pulse_filter_default.csv" )
        MEMBER_PROGOPT( pulse_filter_file_ch_1,            "description",                                  "pulse_filter_default.csv" )
        MEMBER_PROGOPT( pulse_filter_file_ch_2,            "description",                                  "pulse_filter_default.csv" )
