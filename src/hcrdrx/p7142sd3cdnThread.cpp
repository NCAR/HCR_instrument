...
///////////////////////////////////////////////////////////
int
p7142sd3cdnThread::_decodeAndPublishCI(char* buf, int n) {
    return 0;
//
...
///////////////////////////////////////////////////////////
int
p7142sd3cdnThread::_decodeAndPublishRaw(char* buf, int buflen) {
    char* bufPos = buf;
...
//////////////////////////////////////////////////////////////////////////////////
void
p7142sd3cdnThread::_unpackChannelAndPulse(const char* buf, unsigned int & chan, 
