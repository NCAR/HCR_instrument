...
pro hcr_readdat, filename, plot=plot, debug=debug, verbose=verbose, write_data = write_data, umass=umass, nexrad = nexrad
...
IF (plot) THEN BEGIN
window, 1, xsize=800, ysize=1000,title=filename
loadct, 39
!p.multi=[0,1,2]
!p.charsize=1.5
plotheight = 6.0  ; kilometers
