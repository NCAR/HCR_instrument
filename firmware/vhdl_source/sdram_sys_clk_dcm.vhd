...
--                  tions.  For clarity, moved all buffer
--                  instantiations to follow the instantiation of
--                  DCM_ADV (which generates the buffered
--                  signals).
...
PORT (
    ...
    -- 180 Degree Phase Clock Output
    CLK180_OUT  : out std_logic;
    -- 270 Degree Phase Clock Output
...
END SDRAM_SYS_CLK_DCM;

-----------------------------------------------------------------

ARCHITECTURE BEHAVIORAL of SDRAM_SYS_CLK_DCM is
