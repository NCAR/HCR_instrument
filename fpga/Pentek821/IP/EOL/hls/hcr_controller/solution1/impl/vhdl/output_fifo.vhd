...
architecture behav of output_fifo is 
    ...
    signal out_V_TDATA_int : STD_LOGIC_VECTOR (855 downto 0);
...
begin
    ...
    begin
        ...
        out_V_TDATA_int <= std_logic_vector(IEEE.numeric_std.resize(signed(tmp_1_fu_77_p3),856));
    ...
    pulse_terminate_fu_65_p3 <= in_V_dout(852 downto 852);
    tmp_1_fu_77_p3 <= (ap_const_lv1_0 & trunc_ln176_fu_73_p1);
    trunc_ln176_fu_73_p1 <= in_V_dout(852 - 1 downto 0);
end behav;
