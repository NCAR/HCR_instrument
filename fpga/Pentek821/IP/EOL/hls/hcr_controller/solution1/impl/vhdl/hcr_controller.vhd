...
generic (
    C_S_AXI_CFG_BUS_ADDR_WIDTH : INTEGER := 19;
...
port (
    ...
    pulse_metadata_ch1_V_TDATA : OUT STD_LOGIC_VECTOR (951 downto 0);
    pulse_metadata_ch2_V_TDATA : OUT STD_LOGIC_VECTOR (951 downto 0);
...
architecture behav of hcr_controller is 
    ...
    constant ap_const_lv952_lc_2 : STD_LOGIC_VECTOR (951 downto 0) := "";
    ...
    signal cfg_use_mag_phase : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal cfg_pulse_sequence_phase_table_begin_q0 : STD_LOGIC_VECTOR (31 downto 0);
    signal cfg_pulse_sequence_phase_table_end_q0 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal cfg_phase_samples_q0 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal scheduler_parser_U0_cfg_phase_samples_address0 : STD_LOGIC_VECTOR (15 downto 0);
    signal scheduler_parser_U0_cfg_phase_samples_ce0 : STD_LOGIC;
    ...
    signal scheduler_parser_U0_cfg_pulse_sequence_p_5_address0 : STD_LOGIC_VECTOR (4 downto 0);
    signal scheduler_parser_U0_cfg_pulse_sequence_p_5_ce0 : STD_LOGIC;
    ...
    signal scheduler_parser_U0_cfg_pulse_sequence_p_6_address0 : STD_LOGIC_VECTOR (4 downto 0);
    signal scheduler_parser_U0_cfg_pulse_sequence_p_6_ce0 : STD_LOGIC;
    ...
    signal scheduler_parser_U0_cfg_pulse_sequence_p_7_address0 : STD_LOGIC_VECTOR (4 downto 0);
    signal scheduler_parser_U0_cfg_pulse_sequence_p_7_ce0 : STD_LOGIC;
    signal scheduler_parser_U0_cfg_pulse_sequence_p_8_address0 : STD_LOGIC_VECTOR (4 downto 0);
    signal scheduler_parser_U0_cfg_pulse_sequence_p_8_ce0 : STD_LOGIC;
    ...
    signal scheduler_parser_U0_pulse_queue_0_V_din : STD_LOGIC_VECTOR (949 downto 0);
    signal scheduler_parser_U0_pulse_queue_0_V_write : STD_LOGIC;
    signal scheduler_parser_U0_pulse_queue_1_V_din : STD_LOGIC_VECTOR (949 downto 0);
    signal scheduler_parser_U0_pulse_queue_1_V_write : STD_LOGIC;
    signal scheduler_parser_U0_pulse_queue_2_V_din : STD_LOGIC_VECTOR (949 downto 0);
    signal scheduler_parser_U0_pulse_queue_2_V_write : STD_LOGIC;
    signal scheduler_parser_U0_pulse_queue_s_V_din : STD_LOGIC_VECTOR (949 downto 0);
    ...
    signal scheduler_cycle_exac_U0_phase_sample_V : STD_LOGIC_VECTOR (31 downto 0);
    signal scheduler_cycle_exac_U0_phase_sample_V_ap_vld : STD_LOGIC;
    ...
    signal output_fifo70_U0_pulse_metadata_ch0_V_TDATA : STD_LOGIC_VECTOR (951 downto 0);
    ...
    signal output_fifo71_U0_pulse_metadata_ch0_V_TDATA : STD_LOGIC_VECTOR (951 downto 0);
    ...
    port (
        ...
        ap_idle : OUT STD_LOGIC;
        ap_ready : OUT STD_LOGIC;
        in_V_dout : IN STD_LOGIC_VECTOR (949 downto 0);
        in_V_empty_n : IN STD_LOGIC;
        in_V_read : OUT STD_LOGIC;
        out_V_TDATA : OUT STD_LOGIC_VECTOR (951 downto 0);
        out_V_TVALID : OUT STD_LOGIC;
        out_V_TREADY : IN STD_LOGIC );
    end component;


    component fifo_w950_d16_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
        if_write_ce : IN STD_LOGIC;
        if_din : IN STD_LOGIC_VECTOR (949 downto 0);
        if_full_n : OUT STD_LOGIC;
        if_write : IN STD_LOGIC;
        if_dout : OUT STD_LOGIC_VECTOR (949 downto 0);
        if_empty_n : OUT STD_LOGIC;
        if_read : IN STD_LOGIC );
    end component;


    component fifo_w950_d1_A IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
...
begin
    ...
    pulse_queue_ch0_V_U : component fifo_w950_d16_S
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
    ...
    pulse_queue_ch1_V_U : component fifo_w950_d16_S
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    pulse_queue_ch2_V_U : component fifo_w950_d16_S
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    pulse_queue_schedule_1_U : component fifo_w950_d1_A
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
