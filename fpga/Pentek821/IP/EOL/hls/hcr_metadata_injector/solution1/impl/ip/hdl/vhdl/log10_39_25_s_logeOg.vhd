...
entity log10_39_25_s_logeOg_rom is 
    generic(
             DWIDTH     : integer := 18; 
             AWIDTH     : integer := 4; 
             MEM_SIZE    : integer := 16
...
architecture rtl of log10_39_25_s_logeOg_rom is 
...
entity log10_39_25_s_logeOg is
    generic (
...
architecture arch of log10_39_25_s_logeOg is
    component log10_39_25_s_logeOg_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    log10_39_25_s_logeOg_rom_U :  component log10_39_25_s_logeOg_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
