...
entity log10_39_25_s_logcud_rom is 
    generic(
             DWIDTH     : integer := 6; 
             AWIDTH     : integer := 6; 
             MEM_SIZE    : integer := 64
...
architecture rtl of log10_39_25_s_logcud_rom is 
...
entity log10_39_25_s_logcud is
    generic (
        DataWidth : INTEGER := 6;
...
architecture arch of log10_39_25_s_logcud is
    component log10_39_25_s_logcud_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    log10_39_25_s_logcud_rom_U :  component log10_39_25_s_logcud_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
