...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "max_samples_per_cycle" -parent ${ADC_AXI-Stream_Bus} -widget comboBox
  ipgui::add_param $IPINST -name "real_only" -parent ${ADC_AXI-Stream_Bus}
...
proc update_PARAM_VALUE.max_samples_per_cycle { PARAM_VALUE.max_samples_per_cycle } {
	# Procedure called to update max_samples_per_cycle when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.max_samples_per_cycle { PARAM_VALUE.max_samples_per_cycle } {
	# Procedure called to validate max_samples_per_cycle
	return true
}

proc update_PARAM_VALUE.real_only { PARAM_VALUE.real_only } {
	# Procedure called to update real_only when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.real_only { PARAM_VALUE.real_only } {
	# Procedure called to validate real_only
	return true
}
...
proc update_MODELPARAM_VALUE.max_samples_per_cycle { MODELPARAM_VALUE.max_samples_per_cycle PARAM_VALUE.max_samples_per_cycle } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.max_samples_per_cycle}] ${MODELPARAM_VALUE.max_samples_per_cycle}
}

proc update_MODELPARAM_VALUE.real_only { MODELPARAM_VALUE.real_only PARAM_VALUE.real_only } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.real_only}] ${MODELPARAM_VALUE.real_only}
}
