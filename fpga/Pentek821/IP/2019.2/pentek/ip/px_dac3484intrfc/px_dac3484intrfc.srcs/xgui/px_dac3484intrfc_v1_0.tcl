...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "initial_sync_tap_delay"
  ipgui::add_param $IPINST -name "initial_ostrb_tap_delay"
  ipgui::add_param $IPINST -name "idelaycntrl_refclk_freq"
  ipgui::add_param $IPINST -name "iodelay_grp"
...
proc update_PARAM_VALUE.initial_ostrb_tap_delay { PARAM_VALUE.initial_ostrb_tap_delay } {
	# Procedure called to update initial_ostrb_tap_delay when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.initial_ostrb_tap_delay { PARAM_VALUE.initial_ostrb_tap_delay } {
	# Procedure called to validate initial_ostrb_tap_delay
	return true
}
...
proc update_MODELPARAM_VALUE.initial_ostrb_tap_delay { MODELPARAM_VALUE.initial_ostrb_tap_delay PARAM_VALUE.initial_ostrb_tap_delay } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.initial_ostrb_tap_delay}] ${MODELPARAM_VALUE.initial_ostrb_tap_delay}
}
