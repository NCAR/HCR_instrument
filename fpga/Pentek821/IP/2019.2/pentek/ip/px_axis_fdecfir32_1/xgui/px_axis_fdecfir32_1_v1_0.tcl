...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "num_chan" -parent ${Page_0} -widget comboBox
  ipgui::add_param $IPINST -name "out_res" -parent ${Page_0} -widget comboBox
  set bypass_in_lower [ipgui::add_param $IPINST -name "bypass_in_lower" -parent ${Page_0}]
  set_property tooltip {DDC Bypass Data is Right or Left Justified} ${bypass_in_lower}
