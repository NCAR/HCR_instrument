...
pcie_intrfc_i: component pcie_intrfc
     port map (
      ...
      m_axi_acq_csr_arready(0) => m_axi_acq_csr_arready(0),
      m_axi_acq_csr_arvalid(0) => m_axi_acq_csr_arvalid(0),
      ...
      m_axi_acq_csr_awready(0) => m_axi_acq_csr_awready(0),
      m_axi_acq_csr_awvalid(0) => m_axi_acq_csr_awvalid(0),
      m_axi_acq_csr_bready(0) => m_axi_acq_csr_bready(0),
      m_axi_acq_csr_bresp(1 downto 0) => m_axi_acq_csr_bresp(1 downto 0),
      m_axi_acq_csr_bvalid(0) => m_axi_acq_csr_bvalid(0),
      m_axi_acq_csr_rdata(31 downto 0) => m_axi_acq_csr_rdata(31 downto 0),
      m_axi_acq_csr_rready(0) => m_axi_acq_csr_rready(0),
      m_axi_acq_csr_rresp(1 downto 0) => m_axi_acq_csr_rresp(1 downto 0),
      m_axi_acq_csr_rvalid(0) => m_axi_acq_csr_rvalid(0),
      m_axi_acq_csr_wdata(31 downto 0) => m_axi_acq_csr_wdata(31 downto 0),
      m_axi_acq_csr_wready(0) => m_axi_acq_csr_wready(0),
      m_axi_acq_csr_wstrb(3 downto 0) => m_axi_acq_csr_wstrb(3 downto 0),
      m_axi_acq_csr_wvalid(0) => m_axi_acq_csr_wvalid(0),
      ...
      m_axi_dataio_csr_arready(0) => m_axi_dataio_csr_arready(0),
      m_axi_dataio_csr_arvalid(0) => m_axi_dataio_csr_arvalid(0),
      ...
      m_axi_dataio_csr_awready(0) => m_axi_dataio_csr_awready(0),
      m_axi_dataio_csr_awvalid(0) => m_axi_dataio_csr_awvalid(0),
      m_axi_dataio_csr_bready(0) => m_axi_dataio_csr_bready(0),
      m_axi_dataio_csr_bresp(1 downto 0) => m_axi_dataio_csr_bresp(1 downto 0),
      m_axi_dataio_csr_bvalid(0) => m_axi_dataio_csr_bvalid(0),
      m_axi_dataio_csr_rdata(31 downto 0) => m_axi_dataio_csr_rdata(31 downto 0),
      m_axi_dataio_csr_rready(0) => m_axi_dataio_csr_rready(0),
      m_axi_dataio_csr_rresp(1 downto 0) => m_axi_dataio_csr_rresp(1 downto 0),
      m_axi_dataio_csr_rvalid(0) => m_axi_dataio_csr_rvalid(0),
      m_axi_dataio_csr_wdata(31 downto 0) => m_axi_dataio_csr_wdata(31 downto 0),
      m_axi_dataio_csr_wready(0) => m_axi_dataio_csr_wready(0),
      m_axi_dataio_csr_wstrb(3 downto 0) => m_axi_dataio_csr_wstrb(3 downto 0),
      m_axi_dataio_csr_wvalid(0) => m_axi_dataio_csr_wvalid(0),
      ...
      m_axi_dsp_csr_arready(0) => m_axi_dsp_csr_arready(0),
      m_axi_dsp_csr_arvalid(0) => m_axi_dsp_csr_arvalid(0),
      ...
      m_axi_dsp_csr_awready(0) => m_axi_dsp_csr_awready(0),
      m_axi_dsp_csr_awvalid(0) => m_axi_dsp_csr_awvalid(0),
      m_axi_dsp_csr_bready(0) => m_axi_dsp_csr_bready(0),
      m_axi_dsp_csr_bresp(1 downto 0) => m_axi_dsp_csr_bresp(1 downto 0),
      m_axi_dsp_csr_bvalid(0) => m_axi_dsp_csr_bvalid(0),
      m_axi_dsp_csr_rdata(31 downto 0) => m_axi_dsp_csr_rdata(31 downto 0),
      m_axi_dsp_csr_rready(0) => m_axi_dsp_csr_rready(0),
      m_axi_dsp_csr_rresp(1 downto 0) => m_axi_dsp_csr_rresp(1 downto 0),
      m_axi_dsp_csr_rvalid(0) => m_axi_dsp_csr_rvalid(0),
      m_axi_dsp_csr_wdata(31 downto 0) => m_axi_dsp_csr_wdata(31 downto 0),
      m_axi_dsp_csr_wready(0) => m_axi_dsp_csr_wready(0),
      m_axi_dsp_csr_wstrb(3 downto 0) => m_axi_dsp_csr_wstrb(3 downto 0),
      m_axi_dsp_csr_wvalid(0) => m_axi_dsp_csr_wvalid(0),
      ...
      m_axi_user1_csr_arready(0) => m_axi_user1_csr_arready(0),
      m_axi_user1_csr_arvalid(0) => m_axi_user1_csr_arvalid(0),
      ...
      m_axi_user1_csr_awready(0) => m_axi_user1_csr_awready(0),
      m_axi_user1_csr_awvalid(0) => m_axi_user1_csr_awvalid(0),
      m_axi_user1_csr_bready(0) => m_axi_user1_csr_bready(0),
      m_axi_user1_csr_bresp(1 downto 0) => m_axi_user1_csr_bresp(1 downto 0),
      m_axi_user1_csr_bvalid(0) => m_axi_user1_csr_bvalid(0),
      m_axi_user1_csr_rdata(31 downto 0) => m_axi_user1_csr_rdata(31 downto 0),
      m_axi_user1_csr_rready(0) => m_axi_user1_csr_rready(0),
      m_axi_user1_csr_rresp(1 downto 0) => m_axi_user1_csr_rresp(1 downto 0),
      m_axi_user1_csr_rvalid(0) => m_axi_user1_csr_rvalid(0),
      m_axi_user1_csr_wdata(31 downto 0) => m_axi_user1_csr_wdata(31 downto 0),
      m_axi_user1_csr_wready(0) => m_axi_user1_csr_wready(0),
      m_axi_user1_csr_wstrb(3 downto 0) => m_axi_user1_csr_wstrb(3 downto 0),
      m_axi_user1_csr_wvalid(0) => m_axi_user1_csr_wvalid(0),
      ...
      m_axi_user2_csr_arready(0) => m_axi_user2_csr_arready(0),
      m_axi_user2_csr_arvalid(0) => m_axi_user2_csr_arvalid(0),
      ...
      m_axi_user2_csr_awready(0) => m_axi_user2_csr_awready(0),
      m_axi_user2_csr_awvalid(0) => m_axi_user2_csr_awvalid(0),
      m_axi_user2_csr_bready(0) => m_axi_user2_csr_bready(0),
      m_axi_user2_csr_bresp(1 downto 0) => m_axi_user2_csr_bresp(1 downto 0),
      m_axi_user2_csr_bvalid(0) => m_axi_user2_csr_bvalid(0),
      m_axi_user2_csr_rdata(31 downto 0) => m_axi_user2_csr_rdata(31 downto 0),
      m_axi_user2_csr_rready(0) => m_axi_user2_csr_rready(0),
      m_axi_user2_csr_rresp(1 downto 0) => m_axi_user2_csr_rresp(1 downto 0),
      m_axi_user2_csr_rvalid(0) => m_axi_user2_csr_rvalid(0),
      m_axi_user2_csr_wdata(31 downto 0) => m_axi_user2_csr_wdata(31 downto 0),
      m_axi_user2_csr_wready(0) => m_axi_user2_csr_wready(0),
      m_axi_user2_csr_wstrb(3 downto 0) => m_axi_user2_csr_wstrb(3 downto 0),
      m_axi_user2_csr_wvalid(0) => m_axi_user2_csr_wvalid(0),
